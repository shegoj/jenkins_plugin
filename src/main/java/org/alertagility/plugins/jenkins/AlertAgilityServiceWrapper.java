...
public class AlertAgilityServiceWrapper implements IAlertAgilityService {

    private static final Logger logger = Logger.getLogger(AlertAgilityServiceWrapper.class.getName());

    private String serverUrl;
    private String apiKey;
    private String routingKey;

    public AlertAgilityServiceWrapper(String serverUrl, String apiKey, String routingKey) {
        super();
    ...
    public boolean publish(String status, String message, String incident){
        ...
        try {
            ...
            if(responseCode != HttpStatus.SC_OK) {
                logger.log(Level.WARNING, "AlertAgility post may have failed. Response: " + response);
                return false;
            }
            logger.info("AlertAgility post succeeded. Response: " + response);
            return true;
        } catch (Exception e) {
            logger.log(Level.WARNING, "Error posting to AlertAgility", e);
            return false;
        } finally {
